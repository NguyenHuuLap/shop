...
const create = async (data, userId) => {
  ...
  const findFavorite = await favoriteModel.findOne({ productId: data.productId })

  if (findFavorite) {
    return await favoriteModel.findByIdAndUpdate(findFavorite._id, { isDelete: !findFavorite.isDelete }, { new: true });
  }
