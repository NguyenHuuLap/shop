...
const tmnCode = "KNUBTOUI";
const secretKey = "DVVBLSIDSQANRNIUDEGLWHBRNGQDNLDM";
...
async function createPaymentUrl(ipAddress, apiUrl, clientUrl, orderId, orderPayAmount, language = 'vn', bankCode = '') {
  ...
  const createDate = dateFormat(date.toUTCString(), 'yyyymmddHHmmss');
  const txnRef = dateFormat(date.toUTCString(), 'HHmmss');
